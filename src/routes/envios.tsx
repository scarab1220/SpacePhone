...
export const Route = createFileRoute("/envios")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Conoce nuestras opciones de envío, tiempos de entrega y costos.",
      },
      { property: "og:title", content: "Envíos | Space Phone" },
      {
        property: "og:description",
        content: "Opciones de envío, tiempos y costos en Space Phone.",
      },
        ...
        {[
          {
            icon: "flash_on",
            title: "Express",
            text: "1 a 2 días hábiles en zonas metropolitanas.",
          },
