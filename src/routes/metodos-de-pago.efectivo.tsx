...
export const Route = createFileRoute("/metodos-de-pago/efectivo")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Paga en efectivo al recibir o en tienda. Sin recargos ni comisiones.",
      },
      { property: "og:title", content: "Pago en Efectivo | Space Phone" },
      {
        property: "og:description",
        content: "Paga en efectivo al recibir o en tienda. Sin recargos.",
      },
    ...
    >
      <div className="rounded-2xl bg-surface-container border border-outline-variant/20 p-6 md:p-8 space-y-4 text-on-surface-variant">
        ...
        <ol className="list-decimal list-inside space-y-2">
          ...
          <li>
            Visítanos en cualquiera de nuestras{" "}
            <a href="/sucursales" className="text-primary-bright hover:underline">
              3 sucursales
            </a>{" "}
            (Metrocentro, Metrosur o Plaza Mundo Soyapango).
          </li>
