...
export const Route = createFileRoute("/terminos")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Términos y condiciones de uso del sitio y compras en Space Phone." },
      { property: "og:title", content: "Términos y condiciones | Space Phone" },
      { property: "og:description", content: "Términos y condiciones de uso del sitio y compras en Space Phone." },
    ...
    >
      <div className="rounded-2xl bg-surface-container border border-outline-variant/20 p-6 md:p-8 text-on-surface-variant space-y-5 text-sm leading-relaxed">
        <section>
          ...
          <p>El contenido publicado es informativo. Los precios y disponibilidad pueden cambiar sin previo aviso.</p>
        </section>
        <section>
          <h2 className="text-lg font-semibold text-on-surface mb-2">2. Compras</h2>
          <p>Toda compra se confirma a través de nuestros canales de contacto (WhatsApp, Messenger, Instagram). Una vez confirmada, se procede al pago y envío.</p>
        </section>
        <section>
          <h2 className="text-lg font-semibold text-on-surface mb-2">3. Pagos</h2>
          <p>Aceptamos efectivo, transferencias bancarias y tarjetas de crédito (con tasa cero en bancos seleccionados).</p>
        </section>
        <section>
          <h2 className="text-lg font-semibold text-on-surface mb-2">4. Garantía y devoluciones</h2>
          <p>Consulta las páginas de <a href="/garantia" className="text-primary-bright hover:underline">Garantía</a> y <a href="/envios" className="text-primary-bright hover:underline">Envíos</a> para más detalles.</p>
        </section>
        <section>
          <h2 className="text-lg font-semibold text-on-surface mb-2">5. Privacidad</h2>
          <p>Tus datos se utilizan únicamente para procesar tu pedido y brindar soporte. No los compartimos con terceros.</p>
        </section>
        <section>
